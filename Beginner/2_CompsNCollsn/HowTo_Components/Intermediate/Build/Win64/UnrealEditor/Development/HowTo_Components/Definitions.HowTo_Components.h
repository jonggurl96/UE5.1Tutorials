...
#define UE_PROJECT_NAME HowTo_Components
#define UE_TARGET_NAME HowTo_ComponentsEditor
#define UE_MODULE_NAME "HowTo_Components"
...
#define HOWTO_COMPONENTS_API DLLEXPORT
